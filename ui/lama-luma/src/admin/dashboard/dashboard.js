    ...
    return (
        <div >
            ...
            <div className="dashboard-card-collection">
                ...
                <div className="dashboard-card"><div className="dasboad-card-text">Create new loan for the customer and assign a loan for requested item.</div> <Link to= '/admin/dashboard/LoanCardManagement'><button className="dashboard-card-btn">Loan Card Management</button></Link></div>
